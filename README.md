...
## 📝 About The Project
Custom software solution built with Express, MongoDB developed to address specific business requirements for Infeedo Interview Task.
...
1.  **Clone the repository**:
    ```bash
    git clone git@github.com:amitdubeyup/infeedo-interview-task.git
    ```
